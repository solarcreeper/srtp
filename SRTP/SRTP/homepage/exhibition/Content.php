...
<body>
 <div >
	...
	$query = mysql_query("select title,author,category,releaseDate,content from achievement  where aId = $aId");
	while ($row=mysql_fetch_array($query)){
		echo "<p class='location'>您的当前位置：<a href='#'>首页</a>><a href='#'>成果展示</a>><a href='#' style='color:#000;' ></a>$row[2]</p>";
?>
