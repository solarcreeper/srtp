...
<body>
<div >
<p class="location">您的当前位置：<a href="#">首页</a>><a href="#">成果展示</a>><a href="#">机械创新实践班</a></p>
 </div>
...
<?php
	...
	$page = $_GET['page'];
	$result = mysql_query("select aId from achievement where category = '机械创新实践班'");
	...
	$query = mysql_query("select aId,title,category,releaseDate,author,content from achievement  where category = '机械创新实践班' order by aId desc limit  
	$startPage,$pageSize");
...
?>
	...
	<a class='pre' href="machanical.php?page=<?php echo $page - 1;?>">上一页</a>
...
<?php
	...
	if ($page<$totalPage-1) {
?>
	<a class='next' href="machanical.php?page=<?php echo $page + 1;?>">下一页</a>
<?php
	} 
?>
