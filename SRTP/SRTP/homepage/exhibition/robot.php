...
<body>
<div >
<p class="location">您的当前位置：<a href="#">首页</a>><a href="#">成果展示</a>><a href="#">机器人团队</a></p>
 </div>
 <div style="width:720px;height:0px;border-top:1px #999 dashed;position:relative;top:17px;" ></div>

<div id="subject" class="titleStyle" style="font-size:18px;position:relative;top:40px;width:95px;left:0px;">
机器人团队
</div>
...
<?php
	...
	$page = $_GET['page'];
	$result = mysql_query("select aId from achievement where category = '机器人团队'");
	...
	$query = mysql_query("select aId,title,category,releaseDate,author,content from achievement  where category = '机器人团队' order by aId desc limit  
	$startPage,$pageSize");
...
?>
	...
	<a class='pre' href="robot.php?page=<?php echo $page - 1;?>">上一页</a>
...
<?php
	...
	if ($page<$totalPage-1) {
?>
	<a class='next' href="robot.php?page=<?php echo $page + 1;?>">下一页</a>
<?php
	} 
?>
