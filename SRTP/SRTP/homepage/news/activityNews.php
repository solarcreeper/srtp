...
<body>
 <div>
<p class="location">您的当前位置：<a href="#">首页</a>><a href="#">新闻公告</a>><a href="#">活动公告</a></p>
    </div>
...
<?php
	...
	$page = $_GET['page'];
	$result = mysql_query("select sId from subject_news where category = '活动公告'");
	...
	$query = mysql_query("select sId,title,category,releaseDate,author,content from subject_news  where category = '活动公告' order by sId desc limit  
	$startPage,$pageSize");
...
?>
	...
	<a class='pre' href="activityNews.php?page=<?php echo $page - 1;?>">上一页</a>
...
<?php
	...
	if ($page<$totalPage-1) {
?>
	<a class='next' href="activityNews.php?page=<?php echo $page + 1;?>">下一页</a>
<?php
	} 
?>
