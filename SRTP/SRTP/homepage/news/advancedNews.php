...
<body>
 <div >
<p class="location">您的当前位置：<a href="#">首页</a>><a href="#">新闻公告</a>><a href="#">学科前沿</a></p>
 </div>
 <div style="width:720px;height:0px;border-top:1px #999 dashed;position:relative;top:17px;" ></div>

<div id="subject" class="titleStyle" style="font-size:18px;position:relative;top:40px;">
学科前沿
</div>
...
<?php
	...
	$page = $_GET['page'];
	$result = mysql_query("select sId from subject_news where category = '学科前沿'");
	...
	$query = mysql_query("select sId,title,category,releaseDate,author,content from subject_news where category = '学科前沿' order by sId desc limit  
$startPage,$pageSize");
	while ($row=mysql_fetch_array($query)){
		echo "<li>";
		echo "<a href='newsContent.php?sId=$row[0]' class='newsTitle'>";
...
?>
	...
	<a class='pre' href="advancedNews.php?page=<?php echo $page - 1;?>">上一页</a>
...
<?php
	...
	if ($page<$totalPage-1) {
?>
	<a class='next' href="advancedNews.php?page=<?php echo $page + 1;?>">下一页</a>
<?php
	} 
?>
