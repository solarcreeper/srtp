...
<body>
 <div>
<p class="location">您的当前位置：<a href="#">首页</a>><a href="#">新闻公告</a>><a href="#">中心新闻</a></p>
    </div>
...
<?php
	...
	$page = $_GET['page'];
	$result = mysql_query("select sId from subject_news where category = '中心新闻'");
	...
	$query = mysql_query("select sId,title,category,releaseDate,author,content from subject_news  where category = '中心新闻' order by sId desc limit  
	$startPage,$pageSize");
...
?>
	...
	<a class='pre' href="centerNews.php?page=<?php echo $page - 1;?>">上一页</a>
...
<?php
	...
	if ($page<$totalPage-1) {
?>
	<a class='next' href="centerNews.php?page=<?php echo $page + 1;?>">下一页</a>
<?php
	} 
?>
