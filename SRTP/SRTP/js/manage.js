...
addLoadEvent(new Function("hovertabbtn('level1','level2','hove','cur');"));
//menu代表菜单总的ID名称
//level1代表一级菜单项的父容器，level2代表二级菜单项的父容器，
//后面的三个参数style1,style2,style3分别代表鼠标移入，移出，点击的三态样式名
addLoadEvent(new Function("subtabbtn('level2','hove1','cur');"));

/*滑动显隐菜单列表*/
var temp;
var temp1;
function hovertabbtn(cssName1,cssName2,style2,style3){ 
...
//二级菜单绑定事件
function subtabbtn(cssName2,style2,style3){ 
...
function showObj(obj){
	var allhight;
	allhight=obj.getElementsByTagName("li").length*40;//40为每个菜单项的高度，用来计算二级菜单的总高度。
...
<!--$("#hidden").show();--> 
$("iframe").attr("src", "addUser.php"); 
}); 
$("#delUser").click(function () { 
<!--$("#hidden").show();--> 
$("iframe").attr("src", "delUser.php"); 
}); 
$("#addNews").click(function () { 
<!--$("#hidden").show();--> 
$("iframe").attr("src", "./plug-in/addNews.php"); 
});
$("#delNews").click(function () { 
<!--$("#hidden").show();--> 
$("iframe").attr("src", "delNews.php"); 
}); 
$("#addExh").click(function () { 
<!--$("#hidden").show();--> 
$("iframe").attr("src", "./plug-in/addExh.php"); 
});
$("#delExh").click(function () { 
<!--$("#hidden").show();--> 
$("iframe").attr("src", "delExh.php"); 
}); 
$("#application").click(function () { 
<!--$("#hidden").show();--> 
$("iframe").attr("src", "application.php"); 
});
}); 
